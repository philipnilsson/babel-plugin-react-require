    ...
    visitor: {
      ...
      Program: {
        ...
        exit: function (_ref4, _ref5) {
          ...
          var importNode = defaultImport ? t.importDefaultSpecifier : t.importSpecifier;

          var reactImportDeclaration = t.importDeclaration([importNode(t.identifier(name))], t.stringLiteral(lib));
